...
const std::string operation_list_rac_msg = "rac - roman to arabic numbers convertion";
const std::string operation_list_arc_msg = "arc - arabic to roman numbers convertion";
const std::string select_operation_msg = "Select operation:";
...
const std::string selected_rac_operation_msg = "Operation selected: roman to arabic numbers convertion";
const std::string selected_arc_operation_msg = "Operation selected: arabic to roman numbers convertion";
const std::string enter_number_a_msg = "Enter number a:";
const std::string enter_number_b_msg = "Enter number b:";
const std::string enter_roman_num_msg = "Enter roman number:";
const std::string enter_arabic_num_msg = "Enter arabic number:";
const std::string adding_result_msg = "a + b = ";
